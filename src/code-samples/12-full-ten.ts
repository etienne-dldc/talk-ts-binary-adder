...
// prettier-ignore
type Decimal = DecimalTree[any][any][any][any][any][any][any][any][any][any];

// prettier-ignore
type ToBinary<T extends Decimal> = [
  T extends DecimalTree[0][any][any][any][any][any][any][any][any][any] ? 0 : 1,
  T extends DecimalTree[any][0][any][any][any][any][any][any][any][any] ? 0 : 1,
  T extends DecimalTree[any][any][0][any][any][any][any][any][any][any] ? 0 : 1,
  T extends DecimalTree[any][any][any][0][any][any][any][any][any][any] ? 0 : 1,
  T extends DecimalTree[any][any][any][any][0][any][any][any][any][any] ? 0 : 1,
  T extends DecimalTree[any][any][any][any][any][0][any][any][any][any] ? 0 : 1,
  T extends DecimalTree[any][any][any][any][any][any][0][any][any][any] ? 0 : 1,
  T extends DecimalTree[any][any][any][any][any][any][any][0][any][any] ? 0 : 1,
  T extends DecimalTree[any][any][any][any][any][any][any][any][0][any] ? 0 : 1,
  T extends DecimalTree[any][any][any][any][any][any][any][any][any][0] ? 0 : 1,
]
...
type Byte = [Bit, Bit, Bit, Bit, Bit, Bit, Bit, Bit, Bit, Bit];
...
type Reverse<B extends Byte> = [B[9], B[8], B[7], B[6], B[5], B[4], B[3], B[2], B[1], B[0]];
